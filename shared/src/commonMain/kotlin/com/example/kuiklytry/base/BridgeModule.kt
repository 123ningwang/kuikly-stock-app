package com.example.kuiklytry.base
...
internal class BridgeModule : Module() {
    ...
    fun httpRequest(
        ...
        headers?.also { methodArgs.put("headers", it) }
        body?.also { methodArgs.put("body", it) }
        methodArgs.put("timeout", timeoutMs)
        callNativeMethod(HTTP_REQUEST, methodArgs, responseCallbackFn)
    }
